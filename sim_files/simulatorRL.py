'''
This Simulator subclass is tailored for use for the Rice-Line potential, 
created by Chris Liepold. It only changes the pairwise interaction and the 
parameters used for this interaction.
'''
